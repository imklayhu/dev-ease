...
export const tools: ToolItem[] = [
  ...
  },
  {
    id: "sql-formatter",
    title: "SQL 格式化",
    description: "在浏览器内美化 SQL，支持多种方言与关键字大小写。",
    seoDescription:
      "在线 SQL 格式化与缩进：支持 MySQL、PostgreSQL、通用 SQL 等方言，关键字大小写可选；纯前端执行，不上传语句。",
    href: "/tools/sql-formatter/",
    badge: "SQL",
    icon: Database,
    categoryId: "text-data",
    relatedToolIds: ["json-formatter", "markdown-preview"],
  },
  {
    id: "base64",
    title: "Base64 编解码",
  ...
  },
  {
    ...
    icon: QrCode,
    categoryId: "encoding",
    relatedToolIds: ["qr-decode", "url-codec"],
  },
  {
    id: "qr-decode",
    title: "二维码解码",
    description: "上传二维码图片并在浏览器本地解析内容。",
    seoDescription:
      "在线二维码解码工具：上传 PNG/JPG/WebP 等图片并提取二维码文本内容。全程浏览器本地处理，不上传图片。",
    href: "/tools/qr-decode/",
    badge: "QR Decode",
    icon: ScanQrCode,
    categoryId: "encoding",
    relatedToolIds: ["qr-code", "url-parser"],
  },
  {
    id: "timestamp",
    title: "时间戳转换",
    ...
    icon: Clock,
    categoryId: "time-id",
    relatedToolIds: ["cron-parser", "uuid"],
  },
  {
    id: "cron-parser",
    title: "Cron 解析",
    description: "解析 Cron 表达式并预览未来若干次触发时间。",
    seoDescription:
      "在线解析 Cron 表达式，按本地时区列出未来触发时间，便于核对定时任务与 crontab。浏览器内计算，无需后端。",
    href: "/tools/cron-parser/",
    badge: "Cron",
    icon: CalendarClock,
    categoryId: "time-id",
    relatedToolIds: ["timestamp", "uuid"],
  },
  {
    id: "uuid",
    title: "UUID 生成器",
