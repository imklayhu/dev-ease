...
export default function TextCounterPage() {
  const t = useTranslations("toolPages.textCounter");
        ...
        <section className="grid gap-4 lg:grid-cols-[1.15fr_0.85fr] lg:items-start">
          ...
          <aside className="space-y-4">
            <div className="grid gap-3">
              <StatItem icon={AlignLeft} label={t("chars")} value={stats.chars} />
              <StatItem icon={WholeWord} label={t("words")} value={stats.words} />
              <StatItem icon={ListOrdered} label={t("lines")} value={stats.lines} />
            </div>
